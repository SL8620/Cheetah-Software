...
Quadruped<T> buildCyberdog()
{
    ...
    // Parameter
    cheetah._bodyMass = 26.0;
    cheetah._bodyLength = 0.5235;
    cheetah._bodyWidth = 0.33;
    cheetah._bodyHeight = 0.175;

    cheetah._abadGearRatio = 18.655;
    cheetah._hipGearRatio = 16.227;
    cheetah._kneeGearRatio = 21.333;
    
    cheetah._abadLinkLength = 0.5;
    cheetah._hipLinkLength = 0.325;
    cheetah._kneeLinkLength = 0.345;

    cheetah._kneeLinkY_offset = 0.0;
    cheetah._maxLegLength = 0.670;
    
    cheetah._motorTauMax = 150;
    cheetah._batteryV = 48.0;
    ...
    // locations
    cheetah._abadRotorLocation = Vec3<T>(0.975, 0.34, 0);
